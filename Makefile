...
CLI_SRC = cli.c array_free.c split_context.c input_parser.c line_read.c cmd_parser.c split_len.c profile_load.c is_not_comma.c function_parser.c save.c weight_load.c train.c query.c
